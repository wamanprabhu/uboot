...
class fdt_property(_object):
    ...
    if _newclass:tag = _swig_property(_libfdt.fdt_property_tag_get, _libfdt.fdt_property_tag_set)
    __swig_setmethods__["len"] = _libfdt.fdt_property_len_set
    __swig_getmethods__["len"] = _libfdt.fdt_property_len_get
    if _newclass:len = _swig_property(_libfdt.fdt_property_len_get, _libfdt.fdt_property_len_set)
    __swig_setmethods__["nameoff"] = _libfdt.fdt_property_nameoff_set
    __swig_getmethods__["nameoff"] = _libfdt.fdt_property_nameoff_get
    if _newclass:nameoff = _swig_property(_libfdt.fdt_property_nameoff_get, _libfdt.fdt_property_nameoff_set)
    __swig_setmethods__["data"] = _libfdt.fdt_property_data_set
    __swig_getmethods__["data"] = _libfdt.fdt_property_data_get
    if _newclass:data = _swig_property(_libfdt.fdt_property_data_get, _libfdt.fdt_property_data_set)
    def __init__(self): 
...
def fdt_offset_ptr(*args):
  return _libfdt.fdt_offset_ptr(*args)
fdt_offset_ptr = _libfdt.fdt_offset_ptr

def fdt_path_offset(*args):
  return _libfdt.fdt_path_offset(*args)
fdt_path_offset = _libfdt.fdt_path_offset

def fdt_first_property_offset(*args):
  return _libfdt.fdt_first_property_offset(*args)
fdt_first_property_offset = _libfdt.fdt_first_property_offset

def fdt_next_property_offset(*args):
  return _libfdt.fdt_next_property_offset(*args)
fdt_next_property_offset = _libfdt.fdt_next_property_offset

def fdt_strerror(*args):
  return _libfdt.fdt_strerror(*args)
fdt_strerror = _libfdt.fdt_strerror

def fdt_get_property_by_offset(*args):
  return _libfdt.fdt_get_property_by_offset(*args)
fdt_get_property_by_offset = _libfdt.fdt_get_property_by_offset

def fdt_get_name(*args):
  return _libfdt.fdt_get_name(*args)
fdt_get_name = _libfdt.fdt_get_name

def fdt_string(*args):
  return _libfdt.fdt_string(*args)
fdt_string = _libfdt.fdt_string

def fdt_first_subnode(*args):
  return _libfdt.fdt_first_subnode(*args)
fdt_first_subnode = _libfdt.fdt_first_subnode

def fdt_next_subnode(*args):
  return _libfdt.fdt_next_subnode(*args)
fdt_next_subnode = _libfdt.fdt_next_subnode

def fdt_delprop(*args):
  return _libfdt.fdt_delprop(*args)
fdt_delprop = _libfdt.fdt_delprop

def fdt_pack(*args):
  return _libfdt.fdt_pack(*args)
fdt_pack = _libfdt.fdt_pack

def fdt_totalsize(*args):
  return _libfdt.fdt_totalsize(*args)
fdt_totalsize = _libfdt.fdt_totalsize

def fdt_off_dt_struct(*args):
  return _libfdt.fdt_off_dt_struct(*args)
